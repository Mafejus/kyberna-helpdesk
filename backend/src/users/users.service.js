    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.create = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                var existing, hashedPassword, password, rest;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            password = createUserDto.password, rest = __rest(createUserDto, ["password"]);
                            return [2 /*return*/, this.prisma.user.create({
                                    data: __assign(__assign({}, rest), { passwordHash: hashedPassword }),
                                })];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (updateUserDto.role) {
                        throw new common_1.ForbiddenException('Changing role is not allowed');
                    }
                    // Password updates should use the specific endpoint
                    if (updateUserDto.password) {
                        throw new common_1.ForbiddenException('Password update not allowed here. Use /users/:id/password endpoint.');
                    }
        ...
        UsersService_1.prototype.resetPassword = function (id, password) {
            return __awaiter(this, void 0, void 0, function () {
                var passwordHash;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.prisma.user.update({
                                    where: { id: id },
                                    data: { passwordHash: passwordHash, passwordUpdatedAt: new Date() },
                                })];
                    }
                });
            });
        };
        UsersService_1.prototype.changePassword = function (userId, currentPass, newPass) {
            return __awaiter(this, void 0, void 0, function () {
                var user, isMatch, passwordHash;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!user)
                                throw new common_1.NotFoundException('User not found');
                            return [4 /*yield*/, bcrypt.compare(currentPass, user.passwordHash)];
                        case 2:
                            isMatch = _a.sent();
                            if (!isMatch)
                                throw new common_1.ForbiddenException('Invalid current password');
                            return [4 /*yield*/, bcrypt.hash(newPass, 12)];
                        case 3:
                            passwordHash = _a.sent();
