...
var UsersController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('users'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, common_1.Controller)('users')];
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.changePassword = function (req, body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.changePassword(req.user.id, body.currentPassword, body.newPassword)];
                });
            });
        };
        ...
        UsersController_1.prototype.findAll = function (role) {
        ...
        UsersController_1.prototype.resetPassword = function (id, password) {
            if (!password || password.length < 6)
                throw new common_1.BadRequestException('Password min 6 chars');
    ...
    (function () {
        ...
        _changePassword_decorators = [(0, common_1.Patch)('me/password')];
        ...
        _findOne_decorators = [(0, common_1.Get)(':id'), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN)];
        _update_decorators = [(0, common_1.Patch)(':id'), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN)];
        _resetPassword_decorators = [(0, common_1.Patch)(':id/password'), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN)];
