...
var CreateUserDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _email_decorators = [(0, swagger_1.ApiProperty)({ example: 'zak1@ssakhk.cz' }), (0, class_validator_1.IsEmail)()];
            _fullName_decorators = [(0, swagger_1.ApiProperty)({ example: 'Jan Novák' }), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)()];
            _role_decorators = [(0, swagger_1.ApiProperty)({ enum: client_1.Role, example: client_1.Role.STUDENT }), (0, class_validator_1.IsEnum)(client_1.Role)];
