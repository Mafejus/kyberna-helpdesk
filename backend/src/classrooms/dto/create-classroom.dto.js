...
var CreateClassroomDto = function () {
    var _a;
    var _code_decorators;
    var _code_initializers = [];
    var _code_extraInitializers = [];
    return _a = /** @class */ (function () {
            function CreateClassroomDto() {
        ...
        (function () {
            ...
            _code_decorators = [(0, swagger_1.ApiProperty)({ example: '205' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
