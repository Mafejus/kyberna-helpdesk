...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, isProduction, config, document_1, port;
                ...
                case 1:
                    ...
                    app.use((0, helmet_1.default)({
                        ...
                        contentSecurityPolicy: {
                            directives: __assign(__assign({}, helmet_1.default.contentSecurityPolicy.getDefaultDirectives()), { 'font-src': ["'self'", 'data:'], 'img-src': ["'self'", 'data:', 'blob:'] }),
                        },
                    }));
                    ...
                    app.enableCors({
                        origin: isProduction
                            ? ['https://helpdesk.ssakhk.cz', process.env.FRONTEND_URL].filter(function (url) { return !!url; })
                            : [
                                'http://localhost:3000',
