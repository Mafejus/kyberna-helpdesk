...
var AuditController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Audit'), (0, common_1.Controller)('audit'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var AuditController = _classThis = /** @class */ (function () {
        ...
        AuditController_1.prototype.getAuditLogs = function (entityType_1, entityId_1, userId_1) {
            return __awaiter(this, arguments, void 0, function (entityType, entityId, userId, limit, cursor) {
                if (limit === void 0) { limit = '20'; }
                return __generator(this, function (_a) {
                    // Basic validation / conversion
                    return [2 /*return*/, this.auditService.findAll({
                            take: Number(limit),
                            cursor: cursor,
    ...
    (function () {
        ...
        _getAuditLogs_decorators = [(0, common_1.Get)(), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN), (0, swagger_1.ApiOperation)({ summary: 'Get audit logs (Admin only)' })];
