...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.login = function (loginDto) {
            return __awaiter(this, void 0, void 0, function () {
                var allowedDomain, user, payload;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            allowedDomain = this.configService.get('ALLOWED_EMAIL_DOMAIN');
                            if (allowedDomain && !loginDto.email.endsWith("@".concat(allowedDomain))) {
                                throw new common_1.BadRequestException("Email domain must be @".concat(allowedDomain));
                            }
