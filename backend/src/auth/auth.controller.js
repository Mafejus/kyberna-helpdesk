...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.signIn = function (loginDto) {
    ...
    (function () {
        ...
        _signIn_decorators = [(0, throttler_1.Throttle)({ default: { limit: 20, ttl: 60000 } }), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, common_1.Post)('login')];
        _logout_decorators = [(0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)('logout')];
