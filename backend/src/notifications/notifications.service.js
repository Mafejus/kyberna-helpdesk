...
var NotificationsService = function () {
    ...
    var NotificationsService = _classThis = /** @class */ (function () {
        function NotificationsService_1(prisma, preferencesService) {
            this.prisma = prisma;
            this.preferencesService = preferencesService;
        }
        NotificationsService_1.prototype.create = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                var userId, type, skipPreferenceCheck, dbData, user, shouldSend;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            userId = data.userId, type = data.type, skipPreferenceCheck = data.skipPreferenceCheck, dbData = __rest(data, ["userId", "type", "skipPreferenceCheck"]);
                            if (!!skipPreferenceCheck) return [3 /*break*/, 3];
                            return [4 /*yield*/, this.prisma.user.findUnique({ where: { id: userId } })];
                        case 1:
                            user = _a.sent();
                            if (!user) {
                                console.warn("Attempted to send notification to non-existent user ".concat(userId));
                                return [2 /*return*/, null];
                            }
                            return [4 /*yield*/, this.preferencesService.shouldSend(user, type)];
                        case 2:
                            shouldSend = _a.sent();
                            if (!shouldSend)
                                return [2 /*return*/, null];
                            _a.label = 3;
                        case 3: return [2 /*return*/, this.prisma.notification.create({
                                data: __assign({ userId: userId, type: type }, dbData),
                            })];
                    }
                });
            });
        };
        NotificationsService_1.prototype.findAll = function (userId_1) {
