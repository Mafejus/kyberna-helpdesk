...
var NotificationsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Notifications'), (0, common_1.Controller)('notifications'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.getNotifications = function (req, unreadOnly) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.notificationsService.findAll(req.user.id, unreadOnly === '1' || unreadOnly === 'true')];
                });
            });
        };
        NotificationsController_1.prototype.getUnreadCount = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.notificationsService.getUnreadCount(req.user.id)];
                        case 1:
                            count = _a.sent();
        ...
        NotificationsController_1.prototype.markAsRead = function (req, id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
    ...
    (function () {
        ...
        _getNotifications_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Get notifications' })];
        _getUnreadCount_decorators = [(0, common_1.Get)('unread-count'), (0, swagger_1.ApiOperation)({ summary: 'Get unread count' })];
        _markAsRead_decorators = [(0, common_1.Post)(':id/read'), (0, swagger_1.ApiOperation)({ summary: 'Mark notification as read' })];
        _markAllAsRead_decorators = [(0, common_1.Post)('read-all'), (0, swagger_1.ApiOperation)({ summary: 'Mark all notifications as read' })];
